...
<body>
    <div class="flex items-center justify-center min-h-screen bg-center bg-no-repeat bg-gray-200 bg-blend-multiply" style="background-image: url('{{ asset('image/login.png') }}'); background-size: cover;">
